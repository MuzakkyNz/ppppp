...
Tiktok : https://instagram.com/@_zeroyt7

Good ${tampilUcapan}
Saya Zero Bot Yg Siap 
Membantu Anda
Dalam Membuat Sticker , Dll
Silahkan Gunakan Bot Dengan Baik
`
sendButLocation(from, `${menu}`, "*©Created : Zero YT7*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT BOT'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
  break
case 'command':
 listMsg = {
 buttonText: 'LIST MENU',
 footerText: '*©Created : Zero YT7*',
 description: `Hai Kak, Silahkan Pilih MENU BOT Disini..\nJangan Lupa Subscribe Zero YT7 Ya`,
 sections: [
                     {
